...
const maps = {
    ...
    '2024-09-18': {
        blocks: [
            {id: 1, x: 5, y: 0, width: 1, height: 2, direction: 'vertical', color: 'red'},
            {id: 2, x: 4, y: 1, width: 1, height: 2, direction: 'vertical', color: 'red'},
            {id: 3, x: 3, y: 2, width: 1, height: 3, direction: 'vertical', color: 'red'},
            {id: 4, x: 2, y: 2, width: 1, height: 2, direction: 'vertical', color: 'red'},
            {id: 5, x: 0, y: 3, width: 1, height: 2, direction: 'vertical', color: 'red'},
